...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LEFT_RAISE] = LAYOUT_ortho_4x12(
        RCS(KC_TAB), RCTL(KC_R), KC_3,    KC_2,    KC_1,    RCTL(KC_TAB), KC_NO,   KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_BSPC,        
        KC_DEL,      LCTL(KC_C), KC_6,    KC_5,    KC_4,    KC_NO,        KC_NO,   KC_EQL, KC_LBRC, KC_RBRC, KC_SLSH, _______,        
        _______,     LCTL(KC_V), KC_9,    KC_8,    KC_7,    KC_0,         KC_NO,   KC_LT,  KC_GT,   KC_BSLS, KC_BSLS, _______,        
        _______,     LCTL(KC_W), _______, _______, _______, _______,      _______, MO(4),  KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
    [_RIGHT_RAISE] = LAYOUT_ortho_4x12(
        KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_PERC, KC_LCBR,     KC_RCBR, KC_AMPR, KC_CIRC, KC_PAST, KC_QUES, _______,                 
        KC_DEL, KC_QUOT, KC_LPRN, KC_RPRN, KC_UNDS, KC_MINS,     KC_DLR,  KC_EQL,  KC_LBRC, KC_RBRC, KC_SLSH, _______,                 
        _______,KC_PPLS, KC_NO,   KC_NO,   KC_NO,   KC_ACCENT,   KC_TILD, KC_LT,   KC_GT,   KC_NUHS, KC_PIPE, _______,                 
        KC_1,   _______, _______, KC_RALT, MO(4),   _______,     _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
    ),
